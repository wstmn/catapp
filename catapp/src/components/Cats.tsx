...
const [value, copy] = useCopyToClipboard()
  return (
    <div onClick={() => {onOpen(catObj); copy(catObj.breed + " cat")}} id={catObj.id} 
      className='p-4 max-w-6xl w-200 bg-gray-300 hover:bg-gray-600  brightness-100 shadow-md inline-block items-center justify-between m-4 font-roboto rounded ml-4 mr-4 duration-300 text-black hover:text-white'>
